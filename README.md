...
## 安装使用流程如下<br>
### 1、先根据自己的系统选择文件下载<br>
苹果M芯片地址（支持GPU）：[https://down.koudaiqiche.com/obs-beauty-2.2.5-apple.dmg](https://down.koudaiqiche.com/obs-beauty-2.2.5-apple.dmg)<br>
windows下载地址（支持GPU）：[https://down.koudaiqiche.com/obs-beauty-win-2.2.2-x64.exe](https://down.koudaiqiche.com/obs-beauty-win-2.2.2-x64.exe)<br>
...
**设置如下图**<br>
![img32.png](assets/img32.png)<br>
并勾选 **开启背景处理**，可以视频抠图；还可以开启美颜，并设置美颜参数。<br>
